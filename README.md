...
For the execution in Normal IDE like(VS code, Eclipse)

Step 1: Install the available java Extension
Step 2: Use the normal terminal
step 3: open the code path
step 4: Use Javac compiler and execute the code
